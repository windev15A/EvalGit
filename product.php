...
<body>
    ...
    <main>
        <h1 class="display-4 text-center my-4">List des produit</h1>
        <div class="container">
            <div class="row">
                <div class="card col-6 m-4" style="width: 18rem;">
                    <img src="./img/vet1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="card col-6 m-4" style="width: 18rem;">
                    <img src="./img/vet2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-warning">Voir plus ...</a>
                ...
                <div class="card col-6 m-4" style="width: 18rem;">
                    <img src="./img/vet3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-warning">Voir plus ...</a>
                ...
                <div class="card col-6 m-4" style="width: 18rem;">
                    <img src="./img/vet4.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-warning">Voir plus ...</a>
